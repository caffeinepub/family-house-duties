...
export function CalendarWeekPlanner({ selectedDate, onDateChange }: CalendarWeekPlannerProps) {
      ...
      <CardContent className="p-6">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-7">
          {weekDays.map((day) => {
            ...
            const dayChores = getChoresForDate(recurringChores, day);
            ...
            return (
              ...
              >
                ...
                <CardContent className="space-y-3 pb-4">
                  ...
                  {dayTasks.length === 0 && !cookDisplay.label && dayChores.length === 0 && (
